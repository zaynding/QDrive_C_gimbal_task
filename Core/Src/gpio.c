...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_8|GPIO_PIN_0, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : jiguang_Pin */
  GPIO_InitStruct.Pin = jiguang_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(jiguang_GPIO_Port, &GPIO_InitStruct);
